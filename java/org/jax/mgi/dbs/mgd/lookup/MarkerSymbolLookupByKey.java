...
/**
 @is a FullCachedLookup for caching marker symbols by their 
 *  database keys
 * @has a RowDataCacheStrategy of type FULL_CACHE used for creating the
 * cache and performing the cache lookup 
 * @does provides a lookup method to return a marker symbol given
 *  a marker key
 * @company The Jackson Laboratory
 * @author sc
 * @version 1.0
 */
public class MarkerSymbolLookupByKey extends FullCachedLookup {
   ...
   * configuration file
   */
  public MarkerSymbolLookupByKey()
  ...
  /**
   * look up the marker symbol given a marker key
