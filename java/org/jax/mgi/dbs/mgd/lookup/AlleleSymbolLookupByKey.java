 ...
 * @does provides a lookup method to return a allele symbol given
 *  an allele key
 * @company The Jackson Laboratory
 * @author sc
 * @version 1.0
 */
public class AlleleSymbolLookupByKey extends FullCachedLookup {
   ...
   * configuration file
   */
  public AlleleSymbolLookupByKey()
